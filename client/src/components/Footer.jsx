...
import { TextInput, CustomButton } from "./";
const Footer = () => {
  return (
    <footer className="text-white mt-20">
      ...
      <div className="bg-[#1d4ed8]">
        <div className="container px-5 py-20 mx-auto">
          <div className="w-full flex gap-10 justify-between -mb-10 -px-4">
            {footerLinks.map(({ id, title, links }) => (
              <div className="w-auto  px-4" key={title}>
        ...
        <div className="">
          <p className="container mx-auto text-white mt-2">
            Subscribe to our Newsletter
          </p>
          <div className="container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between">
            <div className="w-full md:w-2/4 px-5 pt-6 pb-8 flex flex-wrap items-center justify-between md:justify-start">
              <TextInput
            ...
            <span className="inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto">
              <a className="text-white text-xl hover:scale-125 ease-in-out duration-300 cursor-pointer">
                <FaFacebook />
              </a>
