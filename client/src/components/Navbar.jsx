  ...
  return (
    <div>
      <Menu as="div" className="inline-block text-left">
        ...
        >
          <Menu.Items className="absolute z-50 right-2 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-xl focus:outline-none ">
            <div className="p-1 ">
              <Menu.Item>
                {({ active }) => (
                  <Link
    ...
    <Fragment>
      <div className="relative bg-[#f7fdfd] z-50">
        ...
        >
          ...
          <Link
            to={user?.accountType == "seeker" ? "apply-gistory" : "upload-job"}
